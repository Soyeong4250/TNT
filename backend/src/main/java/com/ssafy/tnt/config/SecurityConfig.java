...
import com.ssafy.tnt.common.auth.JwtAuthenticationFilter;
import com.ssafy.tnt.common.auth.TNTUserDetailService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    @Autowired
    private TNTUserDetailService tntUserDetailService;
    ...
    DaoAuthenticationProvider authenticationProvider() {
        ...
        daoAuthenticationProvider.setUserDetailsService(this.tntUserDetailService);
